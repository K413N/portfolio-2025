...
const PROJECT_DATA = {
	...
	procgen: {
		...
		description:
			"This project is a focused technical demo built to explore procedural generation from the ground up. It served as a learning sandbox where I could experiment with randomly generating different types of plants. The goal wasn't to ship a product but to deeply understand the systems that would later feed into larger projects like Procedural Nightmares.",
